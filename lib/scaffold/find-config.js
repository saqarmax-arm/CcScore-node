...
/**
 * Will return the path and ccscore-node configuration
...
function findConfig(cwd) {
  ...
  while (!fs.existsSync(path.resolve(directory, 'ccscore-node.json'))) {
  ...
  return {
    path: directory,
    config: require(path.resolve(directory, 'ccscore-node.json'))
  };
}
