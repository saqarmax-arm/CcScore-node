...
function main(servicesPath, additionalServices) {
  ...
  program
    ...
    .action(function(services){
      ...
      if (!configInfo) {
        throw new Error('Could not find configuration, see `ccscore-node create --help`');
      }
      var opts = {
      ...
      console.log();
      console.log('    $ ccscore-node add wallet-service');
      console.log('    $ ccscore-node add insight-api');
      console.log();
    });
  ...
  program
    ...
    .action(function(services){
      ...
      console.log('  Examples:');
      console.log();
      console.log('    $ ccscore-node remove wallet-service');
      console.log('    $ ccscore-node remove insight-api');
      console.log();
    });
