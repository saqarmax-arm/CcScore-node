...
describe('#defaultBaseConfig', function() {
  it('will return expected configuration', function() {
    ...
    ccsd.spawn.datadir.should.equal(home + '/.ccs');
    ccsd.spawn.exec.should.equal(path.resolve(__dirname, '../../bin/ccsd'));
  });
  ...
  it('be able to specify a datadir', function() {
    ...
    info.config.servicesConfig.ccsd.spawn.datadir.should.equal('./data2');
  });
});
